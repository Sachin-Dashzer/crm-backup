      ...
      "en-IN"
          ...
          <div class="section">
            ...
            <div class="grid">
              ...
              <div class="info-item"><span class="info-label">Grafting Persons:</span> <span class="info-value">${
                data.surgery.graftingPerson &&
                data.surgery.graftingPerson.length > 0
                  ? Array.isArray(data.surgery.graftingPerson)
                    ? data.surgery.graftingPerson
                        .map((g) => g.name || g)
                        .join(", ")
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            ...
                            patientData.surgery.graftingPerson.length > 0
                              ? Array.isArray(
                                  patientData.surgery.graftingPerson
                                )
                                ? patientData.surgery.graftingPerson
                                    .map((g) => g.name || g)
                                    .join(", ")
                                : patientData.surgery.graftingPerson.name ||
                                  "N/A"
                              : "N/A"}
                          </p>
                        </div>
