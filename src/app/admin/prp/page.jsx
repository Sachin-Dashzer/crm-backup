...
export default function AdminPRPPage() {
  ...
  const [addForm, setAddForm] = useState({
    ...
    isPaid: true, amount: "", discount: "", method: "cash", paymentId: "", remarks: "",
  });
  ...
  const clearPatient = () => {
    setAddForm((f) => ({ ...f, patientId: "", patientName: "", patientPhone: "", patientSearch: "" }));
    setPatientResults([]);
  };
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      ws["!cols"] = [
        { wch: 4 }, { wch: 24 }, { wch: 14 }, { wch: 12 }, { wch: 6 },
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-100 text-left">
                    ...
                    <th className="px-4 py-3.5 font-semibold text-gray-600">Patient Name</th>
                    <th className="px-4 py-3.5 font-semibold text-gray-600">Phone</th>
                    <th className="px-4 py-3.5 font-semibold text-gray-600">Type</th>
                    <th className="px-4 py-3.5 font-semibold text-gray-600">
                      <span className="flex items-center gap-1">
                        <Hash className="w-3.5 h-3.5 text-gray-400" />
                        Session
                      </span>
                    </th>
                    <th className="px-4 py-3.5 font-semibold text-gray-600">Branch</th>
                    <th className="px-4 py-3.5 font-semibold text-gray-600">Amount</th>
                    <th className="px-4 py-3.5 font-semibold text-gray-600">Method</th>
                    <th className="px-4 py-3.5 font-semibold text-gray-600">Time</th>
                ...
                <tbody className="divide-y divide-gray-50">
                  {filtered.map((row, i) => {
                    ...
                    return (
                      <tr
                        key={row.transactionId || `${row.patientId}-${i}`}
                      ...
                      >
                        ...
                        <td className="px-4 py-3.5">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-gray-900 truncate max-w-36">
                        ...
                        <td className="px-4 py-3.5">
                          {row.sessionNumber ? (
                            <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-gray-100 text-gray-700 rounded-lg text-xs font-bold font-mono">
                              #{row.sessionNumber}
                            </span>
                          ) : (
                        ...
                        {/* Method */}
                        <td className="px-4 py-3.5 text-gray-500 capitalize whitespace-nowrap">
                          {row.method || "—"}
                        </td>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  type="date" value={exportTo} min={exportFrom}
                  onChange={(e) => setExportTo(e.target.value)}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-300"
                />
              </div>
              <p className="text-xs text-gray-400">Exports all PRP & GFC sessions (paid + unpaid) for the selected range. Includes session number and discount columns.</p>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg max-h-[92vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-5">
              ...
              <div>
                ...
                <ProcToggle value={addForm.procedure} onChange={(p) => setAddForm((f) => ({ ...f, procedure: p }))} />
              </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                ...
                <div className="flex flex-col items-end gap-1">
                  ...
                  {payTarget.sessionNumber && (
                    <span className="text-xs text-gray-500 font-mono font-semibold">Session #{payTarget.sessionNumber}</span>
                  )}
                </div>
              </div>
