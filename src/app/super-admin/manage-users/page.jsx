...
const ALL_ROLES = ["super-admin", "admin", "sales", "reception", "collab", "surgery", "counsellor", "stock", "hr"];
const BRANCHES = ["Delhi", "Mumbai", "Hyderabad", "Noida", "Collab", "All"];
...
const ROLE_COLOR = {
  ...
  collab:        "bg-cyan-100 text-cyan-700 border-cyan-200",
