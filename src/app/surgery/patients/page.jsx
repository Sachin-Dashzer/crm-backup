...
const STATUS_OPTIONS = [
  "NEW", "NOT_VISITED", "CONSULTED", "NOT_CONVERTED", "SURGERY_BOOKED", "CLOSED",
];
...
function PatientDashboardContent() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (filters.seniorTech)  params.set("seniorTech",      filters.seniorTech);
        if (filters.implanter)   params.set("implanter",       filters.implanter);
  ...
  const clearFilters = () => {
    setFilters({
      status: "", branch: "", counsellor: "", agent: "",
      doctor: "", seniorTech: "", implanter: "", technique: "",
  ...
  if (filters.doctor)          activeFilterChips.push({ k: "doctor",          label: `Doctor: ${filters.doctor}` });
  if (filters.seniorTech)      activeFilterChips.push({ k: "seniorTech",      label: `Senior Tech: ${filters.seniorTech}` });
  if (filters.implanter)       activeFilterChips.push({ k: "implanter",       label: `Implanter: ${filters.implanter}` });
                        ...
                        <tr key={p._id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <div className="flex justify-center space-x-2">
                              ...
                              <Link
                                href={`/surgery/patients/edit/${p._id}`}
            ...
            <div className="absolute right-0 top-0 h-full w-full max-w-md bg-white shadow-xl flex flex-col">
              ...
              <div className="px-6 py-4 border-b bg-white flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Refine your patient search</p>
                </div>
                <button
                  onClick={() => setDrawerOpen(false)}
              ...
              <div className="flex-1 overflow-y-auto">
                <div className="p-6 space-y-6">
                  ...
                  {/* Staff & Team */}
                  <Section title="Staff & Team" icon={<UsersIcon className="w-4 h-4" />}>
                  ...
                  {/* Surgery Details */}
                  <Section title="Surgery Details" icon={<ScissorsIcon className="w-4 h-4" />}>
